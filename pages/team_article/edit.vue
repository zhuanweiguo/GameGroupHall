...
<script>
  import { validator } from '../../js_sdk/validator/team_article.js';

  const db = uniCloud.database();
  const dbCollectionName = 'team_article';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("user_id,title,description,province,content,article_status,delState,last_comment_user_id,picurls,publish_date,last_modify_date").get().then((res) => {
